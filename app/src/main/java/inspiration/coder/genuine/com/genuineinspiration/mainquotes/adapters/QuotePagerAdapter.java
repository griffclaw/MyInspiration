    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String toShare = object.getQuote() + " by " + object.getAuthor() + " отправляйте, используя подлинное вдохновение";
                ...
                try {
                    ...
                    if (fileExists(LIKED_QUOTES)) {
                        ...
                        while (scanner.hasNext()) {
                            ...
                            Log.d("QuotePagerAdapter", "Лайк " + id + " Вы лайкнули цитату = " + quote.getId());
                            if (id == object.getId())
                                isAlreadyLiked = true;
                        }
                        if (isAlreadyLiked) {
                            Toast.makeText(context, "Вы уже лайкнули эту цитату :-)", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                    ...
                    Toast.makeText(context, "Цитата добавлена в список понравившихся", Toast.LENGTH_SHORT).show();
